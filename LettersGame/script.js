...
let roundFields = [];
const roundResults = {};
let durationLocked = false; // لقفل مدة الجولة بعد أول جولة
...
function playStartMelody() {
  playMelody([
    { freq: 523.25, t: 0.00, dur: 0.18, vol: 0.3 },  // C5
    { freq: 659.25, t: 0.20, dur: 0.18, vol: 0.3 },  // E5
    { freq: 783.99, t: 0.40, dur: 0.25, vol: 0.32 }, // G5
    { freq: 1046.50, t: 0.70, dur: 0.25, vol: 0.35 } // C6
  ]);
}
...
function playEndMelody() {
  playMelody([
    { freq: 880.00, t: 0.00, dur: 0.22, vol: 0.28 }, // A5
    { freq: 698.46, t: 0.22, dur: 0.22, vol: 0.26 }, // F5
    { freq: 587.33, t: 0.42, dur: 0.22, vol: 0.24 }, // D5
    { freq: 440.00, t: 0.60, dur: 0.30, vol: 0.22 }  // A4
  ]);
}
...
function startRoundCountdown(durationSeconds) {
  ...
  roundTimer = setInterval(() => {
    ...
    if (remaining === 10) {
      ...
      // بيب خفيفة - احذف السطر لو ما تبغى صوت
